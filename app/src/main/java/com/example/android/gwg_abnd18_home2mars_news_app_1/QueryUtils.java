...
/**
 * Helper methods related to requesting and receiving news articles from The Guardian Newspaper.
 */
public final class QueryUtils {
    ...
    /**
     * Query The Guardian Newspaper dataset and return a list of {@link NewsArticle} objects.
     */
    ...
    private static List<NewsArticle> extractFeatureFromJson(String newsArticleJSON) {
        ...
        try {
            ...
            for (int i = 0; i < newsArticleArray.length(); i++) {
                ...
                NewsArticle newsArticle = new NewsArticle(webTitle, sectionName, byline, webPublicationDate, webUrl);
